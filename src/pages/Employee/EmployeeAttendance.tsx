...
//     id: 1,
//     employeeUserID: "E001",
//     punchIn: "2024-08-01 09:00",
//     punchOut: "2024-08-01 17:00",
//     totalWorkHours: "8h",
//   },
//   {
//     id: 2,
...
//     if (employeeID) {
//       const now = new Date();
//       const punchIn = now.toLocaleString();
...
//       const now = new Date();
//       const punchOut = now.toLocaleString();
//       const punchInDate = new Date(punchInTime);
//       const totalWorkHours =
//         ((now.getTime() - punchInDate.getTime()) / (1000 * 60 * 60)).toFixed(
//           2
//         ) + "h";
...
// src/components/EmployeeAttendance.tsx
import React, { useState } from "react";
